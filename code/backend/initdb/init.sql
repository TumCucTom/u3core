...
CREATE USER IF NOT EXISTS 'general-user'@'%' IDENTIFIED BY 'MLAI2024';

-- Update password in case the user already exists
ALTER USER 'general-user'@'%' IDENTIFIED BY 'MLAI2024';
