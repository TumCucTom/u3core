...
- An example would be where I could not understand why quasar build would run locally but not with github actions on the build.yml
...
- Explain the specifics of the problem I am trying to solve to get better reccomendations.
  - An example of this is the reccomendation of a vue, quasar or node app for our frontend web-app 
